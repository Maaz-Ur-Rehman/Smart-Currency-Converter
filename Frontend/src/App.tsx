...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-custom-gradient min-h-screen flex flex-col md:flex-row items-center justify-between p-6 md:p-10">
    <div className="w-full md:w-1/2 flex items-center justify-center mb-8 md:mb-0">
      <p className="text-white text-3xl md:text-5xl lg:text-7xl mb-6 text-center md:text-left">
        How much are <br />
    ...
    <div className="w-full max-w-lg md:w-1/2 h-auto shadow-lg rounded-lg overflow-hidden bg-white p-6 md:p-8 flex flex-col">
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="relative">
          ...
          {showDropdown && filteredCurrencies.length > 0 && (
            <ul className="mt-2 absolute w-full bg-white shadow-lg rounded-lg max-h-40 overflow-y-auto z-10">
